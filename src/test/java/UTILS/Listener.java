...
public class Listener extends TestListenerAdapter
{
    ...
    public void onStart(ITestContext testContext)
    {
        ...
        htmlReporter.config().setDocumentTitle("UI Watsons Testing Report"); // Tile of report
        htmlReporter.config().setReportName("UI Watsons Testing Report"); // name of the report
        htmlReporter.config().setTheme(Theme.STANDARD);

        extent=new ExtentReports();
        extent.attachReporter(htmlReporter);
        extent.setSystemInfo("Project Name","WATSONS_PROJECT");
